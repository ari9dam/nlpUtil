/**POSUtil.java
 * 4:25:57 PM @author Arindam
 */
package edu.asu.nlu.common.util;
...
public class POSUtil {
	...
	public static boolean isAux(String verb){
		if("be".equalsIgnoreCase(verb)|| "has".equalsIgnoreCase(verb)
				||"have".equalsIgnoreCase(verb)||"do".equalsIgnoreCase(verb))
			return true;
		return false;
	}
